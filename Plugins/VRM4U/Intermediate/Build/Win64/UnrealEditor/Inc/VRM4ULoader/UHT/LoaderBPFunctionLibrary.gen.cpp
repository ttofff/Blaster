...
template<> VRM4ULOADER_API UScriptStruct* StaticStruct<FReturnedData>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULoaderBPFunctionLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ULoaderBPFunctionLibrary_LoadVRMFile, "LoadVRMFile" }, // 1795459939
		{ &Z_Construct_UFunction_ULoaderBPFunctionLibrary_LoadVRMFileAsync, "LoadVRMFileAsync" }, // 2439376556
	...
	struct Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULoaderBPFunctionLibrary, ULoaderBPFunctionLibrary::StaticClass, TEXT("ULoaderBPFunctionLibrary"), &Z_Registration_Info_UClass_ULoaderBPFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoaderBPFunctionLibrary), 3991943843U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_3803666885(TEXT("/Script/VRM4ULoader"),
		Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4ULoader_Public_LoaderBPFunctionLibrary_h_Statics::EnumInfo));
