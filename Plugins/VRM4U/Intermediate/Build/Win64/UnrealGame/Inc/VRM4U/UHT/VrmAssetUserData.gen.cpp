...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVrmAssetUserData_Statics::NewProp_VrmAssetListObject = { "VrmAssetListObject", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UVrmAssetUserData, VrmAssetListObject), Z_Construct_UClass_UVrmAssetListObject_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVrmAssetUserData_Statics::NewProp_VrmAssetListObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmAssetUserData_Statics::NewProp_VrmAssetListObject_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVrmAssetUserData_Statics::ClassParams = {
		...
		0,
		0x003010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UVrmAssetUserData_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmAssetUserData_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4U_Public_VrmAssetUserData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4U_Public_VrmAssetUserData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVrmAssetUserData, UVrmAssetUserData::StaticClass, TEXT("UVrmAssetUserData"), &Z_Registration_Info_UClass_UVrmAssetUserData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVrmAssetUserData), 2091591020U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4U_Public_VrmAssetUserData_h_3733591376(TEXT("/Script/VRM4U"),
		Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4U_Public_VrmAssetUserData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_project_Blaster_Plugins_VRM4U_Source_VRM4U_Public_VrmAssetUserData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
